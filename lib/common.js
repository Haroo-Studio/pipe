...
function saveSignOutLog(userEmail) {
    AccountLog.findOneAndUpdate({ email: userEmail }, { signed_out: Date.now() },
...
function setAccountToClient(codeStub, userData, tokenData) {
    ...
    result.access_host = tokenData.access_host;
    result.access_token = tokenData.access_token;
    result.login_expire = tokenData.login_expire;
